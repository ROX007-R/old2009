...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/ROX007-R/old2009/blob/6ca089bef503ce2b28f66f220d59ec8fc896e875/Apruved.txt"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://www.facebook.com/Rakib0fficials.id")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Rakib0fficials.id"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/ROX007-R/old2009/blob/6ca089bef503ce2b28f66f220d59ec8fc896e875/Apruved.txt"])').text
			if basesplit in plr:
				key = basesplit
